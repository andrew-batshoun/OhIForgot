 ...
 * Generated at: 2022-11-14 22:57:09 UTC
...
public final class tasksPage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/tags/footer.tag", Long.valueOf(1668101661302L));
    _jspx_dependants.put("/WEB-INF/tags/navbar.tag", Long.valueOf(1668103811785L));
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<span class=\"lead\">Add a Task </span>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"formcontainer\">\r\n");
      out.write("\t\t\t\t<form ng-submit=\"ctrl.saveTask()\" name=\"taskForm\"\r\n");
      out.write("\t\t\t\t\tclass=\"form-horizontal\">\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" ng-model=\"ctrl.task.id\" />\r\n");
      out.write("\t\t\t\t\t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group col-md-12\">\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"col-md-2 control-lable\" for=\"descript\">Description</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-7\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" ng-model=\"ctrl.task.description\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tid=\"descript\" class=\" form-control input-sm\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tplaceholder=\"Enter a task description\" required\r\n");
      out.write("\t\t\t\t\t\t\t\t\tng-minlength=\"3\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t<div  ng-show=\"taskForm.$dirty\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span ng-show=\"taskForm.descript.$error.required\">This\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tis a required field</span> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tng-show=\"taskForm.descript.$error.minlength\">Minimum\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tlength required is 3</span> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tng-show=\"taskForm.descript.$invalid\">This field is\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tinvalid </span>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tng-disabled=\"taskForm.$invalid\">\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</form>\r\n");
      out.write("\t\t\t</div>\r\n");
